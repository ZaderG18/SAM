...
$foreignKeys = [
    ...
    "ALTER TABLE professor ADD CONSTRAINT fk_professor_usuarios FOREIGN KEY (id) REFERENCES usuarios(id) ON DELETE CASCADE",
    ...
    "ALTER TABLE mensagens_chat ADD CONSTRAINT fk_mensagens_chat_user_id FOREIGN KEY (user_id) REFERENCES usuarios(id) ON DELETE CASCADE",
    "ALTER TABLE mensagens_chat ADD CONSTRAINT fk_mensagens_chat_receptor_id FOREIGN KEY (receptor_id) REFERENCES usuarios(id) ON DELETE CASCADE",
    "ALTER TABLE mensagens_chat ADD CONSTRAINT fk_mensagens_chat_turma FOREIGN KEY (chat_turma) REFERENCES turma(id) ON DELETE CASCADE",
    ...
    "ALTER TABLE diretor ADD CONSTRAINT fk_diretor_usuarios FOREIGN KEY (id) REFERENCES usuarios(id) ON DELETE CASCADE",
