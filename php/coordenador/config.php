...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['nome'], $_POST['email'], $_POST['cargo'], $_POST['senha'])) {
        ...
        if (isset($_FILES['foto']) && $_FILES['foto']['error'] === UPLOAD_ERR_OK) {
            ...
            if (in_array($fotocargo, $cargosPermitidos)) {
                ...
                window.location.href = '../../pages/coordenador/configuracoes.php';</script>";
            }
        }
        ...
        if ($stmt->execute()) {
            echo "<script> alert('Usuário atualizado com sucesso!'); window.location.href = '../../pages/coordenador/configuracoes.php'; </script>";
        } else {
    ...
    if (isset($_POST['ano-letivo'], $_POST['nota-minima'], $_POST['frequencia-minima'], $_POST['modulos'])) {
        ...
        if ($stmt->execute()) {
            echo "<script> alert('Configurações do sistema salvas com sucesso!'); window.location.href = '../../pages/coordenador/configuracoes.php'; </script>";
        } else {
            echo "Erro: " . $stmt->error;
        }
    ...
    if (isset($_POST['canais'], $_POST['frequencia-notif'])) {
        ...
        if ($stmt->execute()) {
            echo "<script> alert('Notificações salvas com sucesso!'); window.location.href = '../../pages/coordenador/configuracoes.php'; </script>";
        } else {
            echo "Erro: " . $stmt->error;
        }
