    ...
    <header class="header"> 
        ...
        <nav class="nav container" id="menu-mobile">
            ...
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list">
                 <li><a href="../../html/home/home.html" class="nav__link"><img src="../../assets/img/home/icons/Inicio.svg" alt="" srcset="">Início</a></li>
                 <li><a href="../chat/index.html" class="nav__link"><img src="../../assets/img/home/icons/Chat.svg" alt="" srcset="">Chat</a></li>
                 <li><a href="#" class="nav__link"><img src="../../assets/img/home/icons/Cronograma.svg" alt="" srcset="">Cronograma</a></li>
                 <li><a href="../../html/materias/index.html" class="nav__link"><img src="../../assets/img/home/icons/Matérias.svg" alt="" srcset="">Matérias</a></li>
                 <li><a href="../../html/documentos/index.html" class="nav__link"><img src="../../assets/img/home/icons/Solicitação de Documentos.svg" alt="" srcset="">Solicitação de Documentos </a></li>
                 <li><a href="../../html/configuracoes/index.html" class="nav__link"><img src="../../assets/img/home/icons/Configurações.svg" alt="" srcset="">Configurações</a></li>
                 <li><a href="../login/login.html" class="nav__link"><img src="../../assets/img/home/icons/Sair.svg" alt="" srcset="">Sair</a></li>
             </div>
         </nav>
          </div>   
                            ...
                            <div id="sidebar_content">
                               ...
                               <!----- Icone Home ------>
                                <ul id="side_items">
                                    ...
                                    <li class="side-item">
                                        <a href="../../html/documentos/index.html">
                                            <svg width="25" height="25" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li class="side-item">
                                        <a href="../../html/configuracoes/index.html">
                                            <svg width="25" height="25" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
