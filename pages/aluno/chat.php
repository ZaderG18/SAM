...
<head>
    ...
    <title>Chat</title>
                            <!-- CSS-->
    <link rel="stylesheet" href="../../assets/scss/aluno/chat/chat.css">
        ...
        <nav class="nav container" id="menu-mobile">
            ...
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list">
                 ...
                 <li><a href="../../html/chat/index.html" class="nav__link"><img src="../../assets/img/home/icons/Chat.svg" alt="" srcset="">Chat</a></li>
...
<main>
    <div class="chat-container">
        <!-- Sidebar para lista de conversas -->
        <div class="sidebarchat">
            <i class="fas fa-user-plus add-person" onclick="addPerson()"></i>
            <div class="chat-list">
                <h2>Conversas</h2>
                ...
                <div class="chat-item" onclick="openChat('Neide')">
                    <img src="../../assets/img/home/fotos/img_neide.png" alt="User" class="chat-img">
                    <div class="chat-info">
                        <h3>Neide</h3>
                        <p>Última mensagem...</p>
                    </div>
        ...
        <div class="chat-area">
            <div class="chat-header">
                ...
                <img src="../../assets/img/home/fotos/Ana_Icon.png" alt="User" class="chat-header-img">
                <div>
                    <h3>Ana</h3>
            ...
            <div class="message-input">
                ...
                <input type="file" id="file-input" hidden onchange="handleFileInput(event)">
