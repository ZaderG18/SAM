                ...
                <main>
                    <div class="grid-container">
                        ...
                        <class="foto-upload">
                          ...
                          <div class="seguranca-privacidade">
                            <h3>Segurança e Privacidade</h3>
                            <div class="toggle-switch">
                                <label for="toggle-senha">Manter suas senhas seguras</label>
                                <input id="toggle-senha" type="checkbox">
                                <box-icon type='solid' name='toggle-left'></box-icon>
                            </div>
                            <div class="toggle-switch">
                                <label for="toggle-notificacoes">Aceito receber notificações</label>
                                <input id="toggle-notificacoes" type="checkbox">
                            </div>
                            <div class="toggle-switch">
                                <label for="toggle-dados">Não aceito o compartilhamento de dados</label>
                                <input id="toggle-dados" type="checkbox">
                            </div>
                        </div>
                          <div class="solicitacoes">
                            <h3>Solicitações de Arquivos</h3>
