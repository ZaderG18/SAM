...
<body>
   ...
   <header class="header">
    <div class="header__container">
        ...
        <div class="global-container">
            ...
            <main>
                <div class="box-title-dashboard">
                    <div class="flexh1">
                        <h1>Acompanhamento e Intervenções</h1>
                        <i class='bx bx-trending-up nav__icon'></i>
                    </div>            
                </div>
                ...
                <div class="container-content" id="main-content">
                    <section class="dashboard">
                        <div class="flex-box-dashboard">
                            ...
                            <!-- Box para Intervenções Realizadas -->
                            <div class="box-dashboard">
                                <div class="box-icon">
                    ...
                    <section class="section-registro">
                        <h3>Últimos Registros de Intervenções</h3>
            ...
            <aside>
                ...
                <section class="section-aluno">
                    <h6>Lista de Alunos em Risco</h6>
        ...
        <script src="../../../assets/js/diretor/dashboard/acompanhamento.js"></script>
</body>
</html>