...
<head>
    ...
    <link rel="stylesheet" href="../../../assets/scss/diretor/secretaria/satisfacao-sec.css">
   ...
   <header class="header">
                            ...
                            <div class="nav__dropdown">
                              ...
                              <div class="nav__dropdown-collapse">
                                  <div class="nav__dropdown-content">
                                      <a href="l" class="nav__dropdown-item">Home</a>
    ...
    <main>
        <section class="formulario-flex">
            ...
            <form action="" method="post" class="form-container" id="filters">
                <!-- Primeiro grupo de inputs -->
                <fieldset class="step active">
                    <div class="box-legend">
                        <legend class="legend1">Pesquisa de satisfação</legend>
                    ...
                    <div class="box-inputs">
                        ...
                        <div class="input input-right">
                            <label for="satisfaction-level">Nível de Satisfação</label>
                    ...
                    <button type="submit" class="btn-submit" style="background-color: #8aab3d;">Aplicar Filtros</button>
                ...
                <fieldset class="step">
                    <div class="box-legend">
                        <legend class="legend4">Respostas de Satisfação</legend>
                        <div class="line-legend line4"></div>
                    </div>
                    <section class="response-list" id="response-container">
                        <div class="response-card">
                            <h3>Aluno: João Silva</h3>
                            <p>Satisfação: 4/5</p>
                            <p>Comentário: O sistema atende bem às minhas necessidades.</p>
                            <p>Data: 07/11/2024</p>
                        </div>
                        <div class="response-card">
                            <h3>Professor: Ana Costa</h3>
                            <p>Satisfação: 5/5</p>
                            <p>Comentário: O sistema facilita muito a gestão das minhas aulas.</p>
                            <p>Data: 06/11/2024</p>
                        </div>
